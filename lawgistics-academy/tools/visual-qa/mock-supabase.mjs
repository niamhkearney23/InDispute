  ...
  work_posts: [
    {
      ...
      link_url: null,
      memo_path: 'posts/eeee0001-0000-4000-8000-000000000001/memo.webm',
      memo_type: 'audio/webm',
      max_claims: 1,
      expected_minutes: 90,
      trainees_only: true,
      country: 'MY',
  ...
  work_messages: [
    {
      ...
      post_id: 'eeee0001-0000-4000-8000-000000000001',
      thread_user_id: TRAINEE_USER_ID,
      sender_id: TRAINEE_USER_ID,
      body: 'Should the letter mention the earlier quote, or leave it out?',
      sent_at: isoDateFromNow(-1),
    },
    {
      id: 'eeee0004-0000-4000-8000-000000000002',
      post_id: 'eeee0001-0000-4000-8000-000000000001',
      thread_user_id: TRAINEE_USER_ID,
      sender_id: USER_ID,
      body: 'Leave it out. It was never accepted, so it is not a term.',
      sent_at: isoDateFromNow(0),
    },
  ],
  work_submissions: [
    {

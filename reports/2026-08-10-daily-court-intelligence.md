...
Covering the High Court sitting of **Wednesday 5 August 2026**, the most recent verified judgment window.
...
**Why a law student cares.** This is second year administrative law running in the real world. Natural justice, mandatory relevant considerations, jurisdictional error, remedy by certiorari and remitter. If you are studying admin law this semester, this is the case to cite in your exam.

---

## 2. Also handed down 5 August 2026

The High Court delivered five judgments that day:

| Citation | Case | Note |
|---|---|---|
| [2026] HCA 23 | Mpwerempwer Aboriginal Corporation RNTBC v Minister | **Lead, above.** Water licence quashed. |
| [2026] HCA 24 | The King v HCZ | Youth justice. Sentencing of a child for murder, "a particularly heinous offence" under s 176(3)(b)(ii) *Youth Justice Act 1992* (Qld). Issue: whether "special circumstances" under s 227 permitted release before 70 per cent of the detention term was served, and whether the appellate court could interfere with the sentencing judge's conclusion. Bench reported as Gageler CJ, Edelman, Gleeson, Jagot and Beech-Jones JJ. **Outcome not verified this session.** |
| [2026] HCA 25 | Potter (a pseudonym) v The King | Covert recording lawful. Already written up in the 7 August brief, assets built. |
| [2026] HCA 26 | Plaintiff M98/2025 v Minister for Immigration and Citizenship | Migration. Not examined this session. |
| [2026] HCA 27 | Plaintiff S32/2026 v Minister for Immigration and Citizenship | Migration. Not examined this session. |

---

## 3. Verification status, read this before posting

**Sources reachable.** The network egress policy on this environment continues to block `hcourt.gov.au`, `austlii.edu.au`, `fedcourt.gov.au` and `jade.io`, and today also blocked the news sites carrying the wire copy. Everything below was assembled from search result summaries only. This is the same limitation recorded on 30 July and 7 August.
...
- `reports/assets/2026-08-10/water-slide-01.png` to `-06.png`, six slides, navy dominant with a cream closer
- Posting kit: `reports/assets/2026-08-10/POSTING-KIT.md`

## 5. Not run this session

- Federal Court judgments for the week of 3 to 7 August. `fedcourt.gov.au` is blocked and search returned nothing specific for that window. No FCA matters are reported in this edition rather than guessed at.
- State supreme courts, not swept.

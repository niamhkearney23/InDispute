# Posting Kit, Monday 10 August 2026

**Post:** 6 slides, `water-slide-01.png` to `-06.png`, upload in order. Navy dominant, cream closer.
...
Doctrine is only dry until it moves something this large.

*Mpwerempwer Aboriginal Corporation RNTBC v Minister for Territory Families and Urban Housing* [2026] HCA 23
...
#auslaw #lawstudent #lawschool #adminlaw #administrativelaw #nativetitle #highcourt #proceduralfairness #lawyersofinstagram #lawgistics

**Alt text:** Navy and cream carousel explaining the High Court decision quashing a thirty year Northern Territory groundwater licence for want of procedural fairness.
...
First, the case is a reminder of where the real risk sits in major project approvals. Proponents and their advisers spend heavily on the substantive case, the science, the modelling, the economic argument. The vulnerability here was anterior to all of it. Where a statutory power affects identified interests, the opportunity to be heard is a condition of its valid exercise, and no amount of substantive merit repairs its absence.

Second, the remedy matters as much as the finding. The licence is quashed and the application returns to the decision maker. That is not a merits outcome for either side. It is the administrative law system doing precisely what it is designed to do, which is to police the manner of decision making without substituting its own view of the decision.

For students: this is natural justice, mandatory relevant considerations and jurisdictional error operating on a matter of real consequence, in the same week you were probably reading about them in a textbook.

*Mpwerempwer Aboriginal Corporation RNTBC v Minister for Territory Families and Urban Housing* [2026] HCA 23

Details should be checked against the full judgment before relying on them.

---

## Reel script, 30 seconds

**[0:00, slide 1 on screen]**
...
**[0:29]**
Mpwerempwer, 2026, High Court 23.

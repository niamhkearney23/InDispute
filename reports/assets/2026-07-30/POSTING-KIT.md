# Posting Kit, Thursday 30 July 2026
...
## POST 2, Instagram carousel (files b1.png → b6.png)

**Caption (copy-paste):**

Underpaid staff. Personal liability. A creditors' deal that didn't make the regulator go away. 😳

The Full Federal Court's decision in *Elvin v Fair Work Ombudsman* [2026] FCAFC 92 is a masterclass in how underpayment cases really get fought, award classification, procedural fairness and insolvency all in one appeal.

Appeal allowed in part. Cross-appeal dismissed. Lessons for everyone.
...
## POST 2, LinkedIn (text post; optionally attach b1.png as the image)
